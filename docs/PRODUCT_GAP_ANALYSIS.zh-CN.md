...
| `P2` 受控自动化与 operator 面 | 真实云 runtime 仍受 **[`CLOUD_RUNTIME_OOS.zh-CN.md`](CLOUD_RUNTIME_OOS.zh-CN.md)** §4.1/§4.2 约束；**`HM-N12-D01`** 已收口文档 + **`runtime_backend_interface_v1`** OOS 元数据（非 POC）；已完成：`GW-N02-D02`、`GW-N02-D01`、`OPS-N02-D01`、`BRW-N04`、`BRW-N05`、`OPS-RBAC-N01`、`OPS-MW-N01`、`GW-CHAN-N01`、`GW-SLASH-N01`、`OPS-N01-D01` | 详见 [`PLATFORM_SURFACES_SPRINT_PLAN.zh-CN.md`](PLATFORM_SURFACES_SPRINT_PLAN.zh-CN.md) |
