...
| `OPS-N02-D01` | 2026-05-10 | GET /v1/ops/action-audit (ops_action_audit_query_v1), workspaces action_audit_url, actor_prefix filter, OpenAPI | python -m pytest -q cai-agent/tests: PASS (1005 passed, 20 subtests)<br>python scripts/smoke_new_features.py: NEW_FEATURE_CHECKS_OK | finalize_task |
